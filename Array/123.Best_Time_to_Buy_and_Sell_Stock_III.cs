...
the reason why we need to calculate the highest price for P_r is 
because we loop through the original array from last to first and we have to buy first and sell later, 
so we need to backward the process!
*/
